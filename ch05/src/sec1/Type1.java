...
public class Type1 {
	public static void main(String[] args) {
		...
		//스택은 LIFO 구조의 기억장소로 가장 마지막에 입력된 데이터가 가장 먼저 출력될 수 있다. (입구와 출구가 같은 하나의 입출구를가 있음)
		//큐(queue) FIFO 구조의 기억장소는 순서대로 입력되고 출력되므로 가장 처음에 입력된 것이 가장 먼저 출력된다. (입구와 출구가 서로 다름)
		boolean a=true;
		byte b=120;
		char c='a';
		short d=150;
